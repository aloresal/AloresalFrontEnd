<?php if (!defined("_ALORESAL_")) {exit; } ?>

<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-4" style="margin-top:20px;">
		<h2>[API] <?php echo ucfirst($account_checker);?></h2>
    </div>
</div>
<div class="row">
	<div class="col-lg-12">
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox-content forum-container">
				<div class="forum-title">
					...
					<h3><?php echo ucfirst($account_checker);?> API</h3> </div>
				<div class="forum-item active">
					<div class="row">
						<div class="col-md-14">
							<div class="row">
								<div class="form-group">
									<div class="col-md-8"> <label for="mailpass">Account</label> <textarea class="form-control" name="mailpass" id="mailpass" rows="7" placeholder="EMAIL|PASSWORD"></textarea> </div>
						...
						<div class="col-md-14">
							<div class="row">
								<div class="form-group">
                                    ...
                                    <?php echo ucfirst($account_checker);?> region:
                                        <select class="form-control m-b" name="geolocation" id="geolocation" style="text-align: center;display:inline;width: 150px;margin-right: 8px;padding: 4px;" >
                                            <option selected="selected" value="usa"><?php echo ucfirst($account_checker);?> USA / Canada</option>
                                            <option value="uk"><?php echo ucfirst($account_checker);?> UK</option>
                                        </select>
