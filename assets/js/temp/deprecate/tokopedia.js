 ...
 * File:	tokopedia.js
 * Date:	
 * Desc:	Tokopedia API. Modified from http://iace.pw/stylecyb/js/acchckver.js
		...
		success: function(_0x2b8bx26) {
			...
			switch (_0x2b8bx26["code"]) {
				...
				case 3: // DIE
					...
					updateProgress(_0x2b8bx23, lstMail["length"]);
					break;                 
                case 5:   // socks die captcha detect
					updateTextBox("", lstSock[_0x2b8bx24]);
...
$(document).ready (function() {
	...
	0 = Success
	1 = Invalid paramter
    2 = Cann't connect to site
	3 = Account die
	4 = Your account incompatible with our api system 
	5 = Captcha detect
