	...
	$.ajax ({
		...
		error: function(_0x55a8x12, _0x55a8x38, _0x55a8x39) {
			if (_0x55a8x38 != "abort") {
				...
				_0x55a8x3a += "- Status: " + _0x55a8x12["status"] + " - " + _0x55a8x12["statusText"];
				var _0x55a8x28 = _0x55a8x12["responseText"];
				if (_0x55a8x28.indexOf ("on line") != -1) {
					_0x55a8x28 = _0x55a8x28.split ("on line")[1]
				};
				_0x55a8x3a += "- Response: " + _0x55a8x28;
				_0x55a8x3a += "- Message: " + _0x55a8x39;
				_0x55a8x3a += "Please try again or contact admin for this error!";
				jQuery["gritter"].add ({
					title: "MESSAGE!",
					text: _0x55a8x3a,
					class_name: "growl-danger",
		...
		$.ajax ({
			...
			error: function(_0x55a8x12, _0x55a8x38, _0x55a8x39) {
				if (_0x55a8x38 != "abort") {
					...
					_0x55a8x3a += "<br>- Response: " + _0x55a8x28;
