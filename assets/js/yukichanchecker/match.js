 ...
 * File:	default.js
 * Date:
 * Desc:	Default javascript file. Modified from http://iace.pw/stylecyb/js/acchckver.js
 * Copyright (C) 2015 Girudatsu Team (http://girudatsu.com)
 */
...
function check(mailpassIndex, proxySocksIndex, numOfFail) {
    ...
    var geolocation = document.getElementById("geolocation").options[document.getElementById("geolocation").selectedIndex].value;
	...
	$.ajax ({
		...
		success: function(jqXHR) {
			...
			switch (jqXHR["code"]) {
				case 0: // LIVE
					playSound(THIS_SITE_URL+'/assets/sounds/message.mp3');
