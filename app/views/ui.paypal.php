							...
							<div class="row">
								<div class="form-group">
									<div class="" style="text-align: center;">
                                        Token: <input name="token" id="token" style="text-align: left;display:inline;width: 70%;margin-right: 8px;padding: 4px;" value="" class="form-control" type="text" placeholder="x-csrf-jwt">
                                    </div>
                                    <br/>
									<div class="" style="text-align: center;">
